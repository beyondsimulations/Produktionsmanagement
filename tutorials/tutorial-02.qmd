...
Diese Übung behandelt zwei zentrale Themen der Kapazitätsplanung in der Produktion: Warteschlangensysteme und Fließbandabstimmung.

**Wichtige Formeln:**

- **Little's Gesetz**: $L = \lambda \cdot W$ (Bestand = Ankunftsrate × Durchlaufzeit)
- **Auslastung**: $\rho = \frac{\lambda}{\mu}$ (bei einem Server)
- **Mittlerer Bestand (M/M/1)**: $L = \frac{\rho}{1-\rho}$
- **Mittlere Durchlaufzeit (M/M/1)**: $W = \frac{1}{\mu(1-\rho)}$
...
- $P[N \leq 5] = \sum_{n=0}^{5} P[N=n] = 0,333 \cdot \frac{1-0,667^6}{1-0,667} = 0,912$ (91,2%)
- $P[N=0] = 0,333$ (33,3%)
...
- 3 oder weniger: $P[N \leq 3] = 0,12 \cdot \frac{1-0,88^4}{1-0,88} = 0,12 \cdot \frac{0,401}{0,12} = 0,401$ (40,1%)
...
- Station 1 (schneller als Station 2): Wird häufig blockiert, da Puffer 1 sich füllt
- Station 3 (schneller als Station 2): Hungert häufig aus, da Station 2 nicht schnell genug liefert
- Systemtakt wird durch Station 2 auf 5 min pro Werkstück begrenzt

d) **Verbesserungsmaßnahmen:**

1. **Pufferoptimierung:**
   - Puffer 1 verkleinern (da Station 1 ohnehin oft blockiert wird)
   - Puffer 2 vergrößern (um Schwankungen besser auszugleichen)
   - Dadurch: Reduzierte Kapitalbindung bei gleicher Leistung

2. **Kapazitätsanpassung:**
   - Parallelstation zu Station 2 hinzufügen
   - Oder: Prozessverbesserung bei Station 2 zur Reduzierung von $b_2$
   - Ziel: Engpass eliminieren und Systemleistung erhöhen

3. **Alternative: Pull-System einführen:**
   - Kanban-System könnte Blocking reduzieren
   - Produktion nur bei Bedarf der nachgelagerten Station
:::
