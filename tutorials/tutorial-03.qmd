...
Diese Übung behandelt zwei zentrale Konzepte der Produktionsorganisation: die Zentrenproduktion als flexible Alternative zur Werkstattfertigung und das Qualitätsmanagement mit statistischen Methoden.

**Wichtige Konzepte:**

- **Zentrenproduktion**: Gruppierung von Maschinen nach Erzeugnisfamilien
- **Erzeugnisfamilien**: Produkte mit ähnlichen Fertigungsverfahren
- **FFS (Flexibles Fertigungssystem)**: Automatisierte Zentrenproduktion
- **Engpassanalyse**: $\text{Engpass } e = \arg \max_m \left\{ \frac{p_m \cdot b_m}{S_m} \right\}$
...
| Investitionsbedarf | Mittel (evtl. Maschinenduplikation) | Niedrig (Maschinenauslastung optimal) |
...
**Realistische Auslastung**: 85-90% des Engpasses wären praktikabel, was die Systemleistung entsprechend reduziert.
:::
...
- Mittelwert der Stichprobenmittelwerte:
  $\bar{x} = \frac{40,1 + 40,24 + 39,96 + 39,7 + 40,08}{5} = 40,016$ (≈ 40,0%)
...
- **UCL** = $\bar{x} + A \cdot \bar{R} = 40,0 + 0,577 \times 1,04 = 40,0 + 0,60 = 40,60$%
- **LCL** = $\bar{x} - A \cdot \bar{R} = 40,0 - 0,577 \times 1,04 = 40,0 - 0,60 = 39,40$%
